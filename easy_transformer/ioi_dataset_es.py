"""
Spanish variant of the IOI Dataset from "Interpretability in the Wild: 
A Circuit for Indirect Object Identification in GPT-2 Small"

This file provides a Spanish translation of the IOI dataset, maintaining the 
critical pattern where all examples end with "a [A]" (Spanish equivalent of "to [A]").
"""
import io
...
# Common Spanish names (mix of male and female names)
NAMES = [
    "María",
    "José",
    "Juan",
...
# Templates with three names - pattern: ends with "a [A]"
ABC_TEMPLATES = [
    "Luego, [A], [B] y [C] fueron a la [PLACE]. [B] y [C] dieron un [OBJECT] a [A]",
    "Después, [A], [B] y [C] fueron a la [PLACE]. [B] y [C] dieron un [OBJECT] a [A]",
    "Cuando [A], [B] y [C] llegaron a la [PLACE], [B] y [C] dieron un [OBJECT] a [A]",
    "Los amigos [A], [B] y [C] fueron a la [PLACE]. [B] y [C] dieron un [OBJECT] a [A]",
]
...
# Main BABA templates - pattern: ends with "a [A]"
BABA_TEMPLATES = [
    "Luego, [B] y [A] fueron a la [PLACE]. [B] dio un [OBJECT] a [A]",
    "Luego, [B] y [A] se divirtieron mucho en la [PLACE]. [B] dio un [OBJECT] a [A]",
    "Luego, [B] y [A] estaban trabajando en la [PLACE]. [B] decidió dar un [OBJECT] a [A]",
    "Luego, [B] y [A] pensaban en ir a la [PLACE]. [B] quería dar un [OBJECT] a [A]",
    "Luego, [B] y [A] tuvieron una larga discusión, y después [B] dijo a [A]",
    "Después de que [B] y [A] fueron a la [PLACE], [B] dio un [OBJECT] a [A]",
    "Cuando [B] y [A] consiguieron un [OBJECT] en la [PLACE], [B] decidió dárselo a [A]",
    "Cuando [B] y [A] consiguieron un [OBJECT] en la [PLACE], [B] decidió dar el [OBJECT] a [A]",
    "Mientras [B] y [A] trabajaban en la [PLACE], [B] dio un [OBJECT] a [A]",
    "Mientras [B] y [A] iban a la [PLACE], [B] dio un [OBJECT] a [A]",
    "Después del almuerzo, [B] y [A] fueron a la [PLACE]. [B] dio un [OBJECT] a [A]",
    "Luego, [B] y [A] fueron a la [PLACE]. [B] dio un [OBJECT] a [A]",
    "Luego, [B] y [A] tuvieron una larga discusión. Después [B] dijo a [A]",
    "La [PLACE] donde [B] y [A] fueron tenía un [OBJECT]. [B] se lo dio a [A]",
    "Los amigos [B] y [A] encontraron un [OBJECT] en la [PLACE]. [B] se lo dio a [A]",
]

BABA_LONG_TEMPLATES = [
    "Luego por la mañana, [B] y [A] fueron a la [PLACE]. [B] dio un [OBJECT] a [A]",
    "Luego por la mañana, [B] y [A] se divirtieron mucho en la [PLACE]. [B] dio un [OBJECT] a [A]",
    "Luego por la mañana, [B] y [A] estaban trabajando en la [PLACE]. [B] decidió dar un [OBJECT] a [A]",
    "Luego por la mañana, [B] y [A] pensaban en ir a la [PLACE]. [B] quería dar un [OBJECT] a [A]",
    "Luego por la mañana, [B] y [A] tuvieron una larga discusión, y después [B] dijo a [A]",
    "Después de un largo descanso [B] y [A] fueron a la [PLACE], [B] dio un [OBJECT] a [A]",
    "Cuando poco después [B] y [A] consiguieron un [OBJECT] en la [PLACE], [B] decidió dárselo a [A]",
    "Cuando poco después [B] y [A] consiguieron un [OBJECT] en la [PLACE], [B] decidió dar el [OBJECT] a [A]",
    "Pasando tiempo juntos [B] y [A] trabajaban en la [PLACE], [B] dio un [OBJECT] a [A]",
    "Pasando tiempo juntos [B] y [A] iban a la [PLACE], [B] dio un [OBJECT] a [A]",
    "Después del almuerzo por la tarde, [B] y [A] fueron a la [PLACE]. [B] dio un [OBJECT] a [A]",
    "Luego, pasando tiempo juntos [B] y [A] fueron a la [PLACE]. [B] dio un [OBJECT] a [A]",
    "Luego por la mañana después, [B] y [A] tuvieron una larga discusión. Después [B] dijo a [A]",
    "La gran [PLACE] local donde [B] y [A] fueron tenía un [OBJECT]. [B] se lo dio a [A]",
    "Los amigos separados al nacer [B] y [A] encontraron un [OBJECT] en la [PLACE]. [B] se lo dio a [A]",
]
...
BABA_LATE_IOS = [
    ...
    "Luego, [B] y [A] estaban trabajando en la [PLACE]. [B] decidió dar un [OBJECT] a [A]",
    "Luego, [B] y [A] pensaban en ir a la [PLACE]. [B] quería dar un [OBJECT] a [A]",
    "Luego, [B] y [A] tuvieron una larga discusión y después de eso [B] dijo a [A]",
    "Después del almuerzo, [B] y [A] fueron a la [PLACE]. [B] dio un [OBJECT] a [A]",
    "Luego, [B] y [A] fueron a la [PLACE]. [B] dio un [OBJECT] a [A]",
    "Luego, [B] y [A] tuvieron una larga discusión. Después [B] dijo a [A]",
]
...
BABA_EARLY_IOS = [
    "Luego [B] y [A] fueron a la [PLACE], y [B] dio un [OBJECT] a [A]",
    "Luego [B] y [A] se divirtieron mucho en la [PLACE], y [B] dio un [OBJECT] a [A]",
    "Luego [B] y [A] estaban trabajando en la [PLACE], y [B] decidió dar un [OBJECT] a [A]",
    "Luego [B] y [A] pensaban en ir a la [PLACE], y [B] quería dar un [OBJECT] a [A]",
    "Luego [B] y [A] tuvieron una larga discusión, y después de eso [B] dijo a [A]",
    "Después del almuerzo [B] y [A] fueron a la [PLACE], y [B] dio un [OBJECT] a [A]",
    "Luego [B] y [A] fueron a la [PLACE], y [B] dio un [OBJECT] a [A]",
    "Luego [B] y [A] tuvieron una larga discusión, y después [B] dijo a [A]",
]
...
# Spanish verbs (past participle forms common in these contexts)
VERBS = [" intentó", " dijo", " decidió", " quiso", " dio"]

# Spanish places (with feminine article "la" to match templates)
PLACES = [
    "tienda",
    "jardín",
    "restaurante",
...
PREFIXES = [
    "             Luego,",
    "            Dos amigos se encontraron en un bar. Después,",
...
def flip_prefixes(ioi_prompts):
    ...
    for prompt in ioi_prompts:
        if prompt["text"].startswith("La ") or prompt["text"].startswith("El "):
            prompt["text"] = "Después del almuerzo, la" + prompt["text"][3:]
        else:
...
class IOIDatasetES:
    """
    Spanish variant of the IOI Dataset.
    ...
    def __init__(
        ...
        self.prompt_type = prompt_type
        if prompts is None:
            self.ioi_prompts = gen_prompt_uniform(  # a list of dict of the form {"text": "María y José bla bla. José dio bla a María", "IO": "María", "S": "José"}
                self.templates,
                NAMES,
    ...
    def construct_from_ioi_prompts_metadata(cls, templates, ioi_prompts_data, **kwargs):
        ...
        create and IOIDatasetES from these
        """
        ...
        return IOIDatasetES(prompt_type=templates, prompts=prompts, **kwargs)

    def gen_flipped_prompts(self, flip):
        """
        Return a IOIDatasetES where the name to flip has been replaced by a random name.
        """
        ...
        flipped_ioi_dataset = IOIDatasetES(
