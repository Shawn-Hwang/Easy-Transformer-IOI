"""
French variant of the IOI Dataset from "Interpretability in the Wild: 
A Circuit for Indirect Object Identification in GPT-2 Small"

This file provides a French translation of the IOI dataset, maintaining the 
critical pattern where all examples end with "à [A]" (French equivalent of "to [A]").
"""
import io
...
# Common French names (mix of male and female names)
NAMES = [
    "Marie",
    "Jean",
    "Pierre",
...
# Templates with three names - pattern: ends with "à [A]"
ABC_TEMPLATES = [
    "Ensuite, [A], [B] et [C] sont allés au [PLACE]. [B] et [C] ont donné un [OBJECT] à [A]",
    "Après, [A], [B] et [C] sont allés au [PLACE]. [B] et [C] ont donné un [OBJECT] à [A]",
    "Quand [A], [B] et [C] sont arrivés au [PLACE], [B] et [C] ont donné un [OBJECT] à [A]",
    "Les amis [A], [B] et [C] sont allés au [PLACE]. [B] et [C] ont donné un [OBJECT] à [A]",
]
...
# Main BABA templates - pattern: ends with "à [A]"
BABA_TEMPLATES = [
    "Ensuite, [B] et [A] sont allés au [PLACE]. [B] a donné un [OBJECT] à [A]",
    "Ensuite, [B] et [A] se sont bien amusés au [PLACE]. [B] a donné un [OBJECT] à [A]",
    "Ensuite, [B] et [A] travaillaient au [PLACE]. [B] a décidé de donner un [OBJECT] à [A]",
    "Ensuite, [B] et [A] pensaient aller au [PLACE]. [B] voulait donner un [OBJECT] à [A]",
    "Ensuite, [B] et [A] ont eu une longue dispute, et après [B] a dit à [A]",
    "Après que [B] et [A] soient allés au [PLACE], [B] a donné un [OBJECT] à [A]",
    "Quand [B] et [A] ont eu un [OBJECT] au [PLACE], [B] a décidé de le donner à [A]",
    "Quand [B] et [A] ont eu un [OBJECT] au [PLACE], [B] a décidé de donner le [OBJECT] à [A]",
    "Pendant que [B] et [A] travaillaient au [PLACE], [B] a donné un [OBJECT] à [A]",
    "Pendant que [B] et [A] se rendaient au [PLACE], [B] a donné un [OBJECT] à [A]",
    "Après le déjeuner, [B] et [A] sont allés au [PLACE]. [B] a donné un [OBJECT] à [A]",
    "Ensuite, [B] et [A] sont allés au [PLACE]. [B] a donné un [OBJECT] à [A]",
    "Ensuite, [B] et [A] ont eu une longue dispute. Après [B] a dit à [A]",
    "Le [PLACE] où [B] et [A] sont allés avait un [OBJECT]. [B] l'a donné à [A]",
    "Les amis [B] et [A] ont trouvé un [OBJECT] au [PLACE]. [B] l'a donné à [A]",
]

BABA_LONG_TEMPLATES = [
    "Ensuite le matin, [B] et [A] sont allés au [PLACE]. [B] a donné un [OBJECT] à [A]",
    "Ensuite le matin, [B] et [A] se sont bien amusés au [PLACE]. [B] a donné un [OBJECT] à [A]",
    "Ensuite le matin, [B] et [A] travaillaient au [PLACE]. [B] a décidé de donner un [OBJECT] à [A]",
    "Ensuite le matin, [B] et [A] pensaient aller au [PLACE]. [B] voulait donner un [OBJECT] à [A]",
    "Ensuite le matin, [B] et [A] ont eu une longue dispute, et après [B] a dit à [A]",
    "Après une longue pause [B] et [A] sont allés au [PLACE], [B] a donné un [OBJECT] à [A]",
    "Quand peu après [B] et [A] ont eu un [OBJECT] au [PLACE], [B] a décidé de le donner à [A]",
    "Quand peu après [B] et [A] ont eu un [OBJECT] au [PLACE], [B] a décidé de donner le [OBJECT] à [A]",
    "En passant du temps ensemble [B] et [A] travaillaient au [PLACE], [B] a donné un [OBJECT] à [A]",
    "En passant du temps ensemble [B] et [A] se rendaient au [PLACE], [B] a donné un [OBJECT] à [A]",
    "Après le déjeuner l'après-midi, [B] et [A] sont allés au [PLACE]. [B] a donné un [OBJECT] à [A]",
    "Ensuite, en passant du temps ensemble [B] et [A] sont allés au [PLACE]. [B] a donné un [OBJECT] à [A]",
    "Ensuite le matin après, [B] et [A] ont eu une longue dispute. Après [B] a dit à [A]",
    "Le grand [PLACE] local où [B] et [A] sont allés avait un [OBJECT]. [B] l'a donné à [A]",
    "Les amis séparés à la naissance [B] et [A] ont trouvé un [OBJECT] au [PLACE]. [B] l'a donné à [A]",
]
...
BABA_LATE_IOS = [
    ...
    "Ensuite, [B] et [A] travaillaient au [PLACE]. [B] a décidé de donner un [OBJECT] à [A]",
    "Ensuite, [B] et [A] pensaient aller au [PLACE]. [B] voulait donner un [OBJECT] à [A]",
    "Ensuite, [B] et [A] ont eu une longue dispute et après cela [B] a dit à [A]",
    "Après le déjeuner, [B] et [A] sont allés au [PLACE]. [B] a donné un [OBJECT] à [A]",
    "Ensuite, [B] et [A] sont allés au [PLACE]. [B] a donné un [OBJECT] à [A]",
    "Ensuite, [B] et [A] ont eu une longue dispute. Après [B] a dit à [A]",
]
...
BABA_EARLY_IOS = [
    "Ensuite [B] et [A] sont allés au [PLACE], et [B] a donné un [OBJECT] à [A]",
    "Ensuite [B] et [A] se sont bien amusés au [PLACE], et [B] a donné un [OBJECT] à [A]",
    "Ensuite [B] et [A] travaillaient au [PLACE], et [B] a décidé de donner un [OBJECT] à [A]",
    "Ensuite [B] et [A] pensaient aller au [PLACE], et [B] voulait donner un [OBJECT] à [A]",
    "Ensuite [B] et [A] ont eu une longue dispute, et après cela [B] a dit à [A]",
    "Après le déjeuner [B] et [A] sont allés au [PLACE], et [B] a donné un [OBJECT] à [A]",
    "Ensuite [B] et [A] sont allés au [PLACE], et [B] a donné un [OBJECT] à [A]",
    "Ensuite [B] et [A] ont eu une longue dispute, et après [B] a dit à [A]",
]
...
# French verbs (past participle forms common in these contexts)
VERBS = [" essayé", " dit", " décidé", " voulu", " donné"]
...
PREFIXES = [
    "             Ensuite,",
    "            Deux amis se sont rencontrés dans un bar. Puis,",
...
def flip_prefixes(ioi_prompts):
    ...
    for prompt in ioi_prompts:
        if prompt["text"].startswith("Le ") or prompt["text"].startswith("La "):
            prompt["text"] = "Après le déjeuner, le" + prompt["text"][3:]
        else:
...
class IOIDatasetFR:
    """
    French variant of the IOI Dataset.
    Can be used as a drop-in replacement for IOIDataset in experiments.
    """
    def __init__(
        self,
        prompt_type: Union[
        ...
        self.prompt_type = prompt_type
        if prompts is None:
            self.ioi_prompts = gen_prompt_uniform(  # a list of dict of the form {"text": "Alice et Bob bla bla. Bob a donné bla à Alice", "IO": "Alice", "S": "Bob"}
                self.templates,
                NAMES,
    ...
    def construct_from_ioi_prompts_metadata(cls, templates, ioi_prompts_data, **kwargs):
        ...
        create and IOIDatasetFR from these
        """
        ...
        return IOIDatasetFR(prompt_type=templates, prompts=prompts, **kwargs)

    def gen_flipped_prompts(self, flip):
        """
        Return a IOIDatasetFR where the name to flip has been replaced by a random name.
        """
        ...
        flipped_ioi_dataset = IOIDatasetFR(
